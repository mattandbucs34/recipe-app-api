...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Eggplant Casserole')
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Frank and Beans')
